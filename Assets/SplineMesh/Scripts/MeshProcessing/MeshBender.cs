...
namespace SplineMesh {
    ...
    public class MeshBender : MonoBehaviour {
        ...
        private float customIntervalStart, customIntervalEnd;
        ...
        public void SetCustomInterval(float start, float end) 
        {
            customIntervalStart = start;
            customIntervalEnd = end;
            SetDirty();
        }
        ...
        private void OnEnable() {
            ...
            else 
            {
                ...
                result.name = "Collider generated by " + GetType().Name;
            }
            if (GetComponent<MeshCollider>()) 
            {
                if (GetComponent<MeshCollider>().sharedMesh != null)
                {
                    result = GetComponent<MeshCollider>().sharedMesh;
                }
                else
                {
                    GetComponent<MeshCollider>().sharedMesh = result = new Mesh();
                    result.name = "Collider generated by " + GetType().Name;
                }
            }
        }
        ...
        private  void Compute() {
            ...
            switch (Mode) {
                ...
                case FillingMode.StretchToInterval:
                    FillStretch();
                    break;
                case FillingMode.CustomIntervals:
                    FillCustomIntervals();
                    break;
            }
        }
